...
const FourthStep: React.FC = () => {
  return (
    <div>
      ...
      <p>
        No está permitido entrar a los dormitorios de sexo opuesto, como tampoco a las oficinas del equipo coordinador, asimismo, durante el tiempo de plenarias u otras actividades.
        Durante el evento el asistente se compromete a respetar los horarios y cumplir el programa, asistiendo a las actividades obligatorias.
        El asistente tiene que sujetarse al programa general tales como horarios de comida, duchas, descanso etc.
        Todos los participantes deberán obedecer los lineamientos tanto de voluntarios como de equipo coordinador.
      ...
      <p>
        Si alguno de los asistentes o persona externa es sorprendido en situación de robo u otro delito, será excluido del evento, expulsado del predio y denunciado a las autoridades respectivas.
      </p>
      <p>
        Si no puedes asistir: La reserva no es reembolsable, otra persona puede ir en tu lugar haciendo los pasos de inscripción e informando a la JEBE (Juventud Evangélica Bautista Ecuatoriana) hasta el 15 de Mayo del 2024.
      </p>
      <p>
        Al enviar el formulario, aceptas los términos y condiciones.
      </p>
      <p>
